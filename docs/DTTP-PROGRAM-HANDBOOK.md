...
**90-Day Full-Stack Software Development & Professional Development Program**

| | |
| --- | --- |
| **Primary Outcome** | Junior Full-Stack Developer |
| **Backend Tracks** | Java / Spring Boot **or** Python / FastAPI |
| **Frontend** | React + TypeScript |
| **Database** | MySQL / PostgreSQL |
| **Delivery** | Git + GitHub + Docker + CI/CD + AWS |
| **Duration** | 90 days · 12 phases |
...
1. [Program Purpose](#1-program-purpose)
2. [Program Vision](#2-program-vision)
3. [Program Mission](#3-program-mission)
4. [Three-Dimensional Development Model](#4-three-dimensional-development-model)
5. [Technology Architecture](#5-technology-architecture)
6. [Trainee Journey](#6-trainee-journey)
7. [90-Day Master Roadmap](#7-90-day-master-roadmap)
8. [Training Methodology](#8-training-methodology)
9. [Daily Development Cycle](#9-daily-development-cycle)
10. [Phase 1 — Orientation](#10-phase-1--orientation)
11. [Baseline Assessment](#11-baseline-assessment)
12. [Git & GitHub](#12-git--github)
13. [Phase 2 — Programming](#13-phase-2--programming)
14. [Java Track](#14-java-track)
15. [Spring Boot](#15-spring-boot)
16. [Python Track](#16-python-track)
17. [FastAPI](#17-fastapi)
18. [Frontend](#18-frontend--react--typescript)
19. [Database](#19-database)
20. [REST API](#20-rest-api)
21. [Major Training Project](#21-major-training-project)
22. [Full-Stack Architecture](#22-full-stack-architecture)
...
27. [CI/CD](#27-cicd)
28. [AWS](#28-aws)
29. [Project Management](#29-project-management)
30. [Definition of Done](#30-definition-of-done)
31. [Mentor System](#31-mentor-system)
32. [Daily Report](#32-daily-report)
33. [Weekly Review](#33-weekly-review)
34. [Competency Model](#34-competency-model)
35. [Performance Status](#35-performance-status)
36. [Weekly Score](#36-weekly-score)
37. [Final Assessment](#37-final-assessment)
38. [Graduation Levels](#38-graduation-levels)
39. [Production Readiness Gate](#39-production-readiness-gate)
40. [Career Progression](#40-career-progression)
41. [DTTP Management System](#41-dttp-management-system)
42. [Final DTTP Standard](#42-final-dttp-standard)
...
The program does **not** define success as completion of 90 days.
...
10. Create a repeatable internal talent-development system for Deshmukh Technologies.

---

## 4. Three-Dimensional Development Model
...
```text
Testing → Security → Docker → CI/CD → AWS → Monitoring
```
...
## 9. Daily Development Cycle

```text
LEARN → UNDERSTAND → PRACTICE → IMPLEMENT → TEST
   → DEBUG → COMMIT → PULL REQUEST → CODE REVIEW → IMPROVE
```
...
Before technical training begins, assess the following. The result becomes the trainee's **Baseline Skill Profile**.
...
Both backend tracks implement the same business API. This ensures that Java and Python trainees learn the same API design principles.
...
Both implementations should satisfy the same business requirements.
...
Trainees containerize the application.
...
- **1 Primary Mentor**
- **1 Technical Reviewer** (where practical)

### Mentor KPIs

The mentor should be measured on:
...
| **L3** | Performs independently |
| **L4** | Can review / explain |
| **L5** | Can own |

### Graduation target

Most core skills should reach **L3**.
...
| --- | --- | --- |
| 🟢 **GREEN** | On track | Continue the standard path |
| 🟡 **AMBER** | Needs improvement | Individual Improvement Plan |
| 🔴 **RED** | At risk | Individual Improvement Plan |
...
| Score | Level | Outcome |
| ---: | --- | --- |
| **85–100** | Developer Ready | Eligible for Junior Full-Stack Developer responsibilities |
| **70–84** | Junior Developer — Supervised | Can contribute with closer mentoring |
| **55–69** | Extended Training | Requires additional structured training |
| **Below 55** | Management Review | Formal decision required |
...
The long-term goal should be an internal **Trainee Management System**.
...
The program should **not** ask:

> How many technologies did the trainee complete?
...
A disciplined, technically capable and production-ready Junior Full-Stack Developer.
