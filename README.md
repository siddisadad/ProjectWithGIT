...
| [TMS Detailed Specification](docs/DTTP-TMS.pdf) | Python-track trainees | **Main PDF.** DTTP-TMS-001 — all 32 sections | 1.0 |
...
| Format | Profile | Handbook | Setup | Self-growth | TMS Spec |
| --- | --- | --- | --- | --- | --- |
...
**[`docs/DTTP-TMS.pdf`](docs/DTTP-TMS.pdf)** is the detailed Real-Time Project Specification (DTTP-TMS-001). The brief, MVP-1, and Sprint 1 sheets are shorter handouts of the same product.
